...
@Component({
  selector: 'app-comparaison-visa-p',
  templateUrl: './comparaison-visa-p.component.html',
  styleUrls: ['./comparaison-visa-p.component.css']
})
export class ComparaisonVisaPComponent implements OnInit {
