...
@Component({
  selector: 'app-domainechart',
  templateUrl: './domainechart.component.html',
  styleUrls: ['./domainechart.component.css']
})
export class DomainechartComponent implements OnInit {
