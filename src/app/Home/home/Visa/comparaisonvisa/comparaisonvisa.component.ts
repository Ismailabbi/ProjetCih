...
@Component({
  selector: 'app-comparaisonvisa',
  templateUrl: './comparaisonvisa.component.html',
  styleUrls: ['./comparaisonvisa.component.css']
})
export class ComparaisonvisaComponent implements OnInit {
